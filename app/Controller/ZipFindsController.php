<?php
    class ZipFindsController extends AppController{
        ...
        public function view(){
            ...
            $zipFinds = $this -> ZipFind -> find('all', array('fields' => array('DISTINCT(ZipFind.county_name)','zip','zip_code','state_name'),'conditions' => array('ZipFind.zip_code' => $this->request->data['ZipFind']['query'])));
